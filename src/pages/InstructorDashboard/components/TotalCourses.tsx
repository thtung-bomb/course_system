...
import on from '@assets/images/imgInstructorDashboard/online-course.svg';
...
const DashboardCardTotalCourses: React.FC<DashboardCardProps> = ({ title, number, new: newCount }) => {
    return (
        <Card>
            <CardDash>
                <CardDashLeft>
...
export default DashboardCardTotalCourses;
