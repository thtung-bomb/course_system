...
import know from '@assets/images/imgInstructorDashboard/knowledge.svg';
...
const DashboardCardTotalStudents: React.FC<DashboardCardProps> = ({ title, number, new: newCount }) => {
    return (
        <Card>
            <CardDash>
                <CardDashLeft>
...
export default DashboardCardTotalStudents;
